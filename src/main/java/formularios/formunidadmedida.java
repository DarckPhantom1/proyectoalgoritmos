...
public class formunidadmedida extends javax.swing.JFrame {
  ...
  public void mostrardatos(){
      String[] titulos= {"ID Medida","NOMBRE"};
      String[]registros= new String[2];
      DefaultTableModel modelo=new DefaultTableModel(null,titulos);
      String SQL ="select idmedida,nombre,activo from unidadmedida u where activo ='Si'";
    ...
    public void eliminarRegistros(){
       ...
       try{
          ...
          String SQL="update unidadmedida set activo ='No' where idmedida="+tblUsuarios.getValueAt(filaSeleccionada, 0);
       ...
       try{
          ...
          int sucursal=1;
           if (nusuario == null || nusuario.trim().isEmpty()) {
            JOptionPane.showMessageDialog( null,"Unidad de medida no puede ser vacio");
           }else{
               
        String SQLVerificar = "SELECT COUNT(*) AS cantidad FROM  unidadmedida p WHERE nombre=? AND activo = 'Si'";
        ...
        if (rs.getInt(1) > 0) {
            JOptionPane.showMessageDialog(null, "La unidad de medida ya existe. Por favor, elija otra unidad de medida.");
        ...
        //   String passwordBase64 = Base64.getEncoder().encodeToString(nusuario.getBytes("UTF-8"));
          String SQL="insert into unidadmedida (nombre,activo) values(?,?)";
  ...
  int filaSeleccionada=tblUsuarios.rowAtPoint(evt.getPoint());       // TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       try{
           ...
           String SQL="update unidadmedida set nombre=? where idmedida=?";
