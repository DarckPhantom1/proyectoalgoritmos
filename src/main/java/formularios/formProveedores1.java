 ...
 * @author Rony
 */
public class formProveedores1 extends javax.swing.JFrame {
conexionSQL cc = new conexionSQL();
    Connection con = cc.conexion();
    String usuario=nombreUsuario.toUpperCase();
    
  public void mostrardatos(){
      String[] titulos= {"ID PROVEEDOR","NOMBRE","TELEFONO","DIRECCION"};
      String[]registros= new String[4];
      DefaultTableModel modelo=new DefaultTableModel(null,titulos);
      String SQL ="select idProveedor,nombre,telefono,direccion from inventariofacturacion.proveedores where activo='Si'";
    ...
    public void eliminarRegistros(){
       ...
       try{
          ...
          String SQL="update proveedores set activo ='No' where idProveedor="+tblUsuarios.getValueAt(filaSeleccionada, 0);
     ...
     public void insertarDatos(){
       ...
       try{
           ...
           if (nusuario == null || nusuario.trim().isEmpty()) {
            JOptionPane.showMessageDialog( null,"Nombre de proveedor no puede ser vacio");
           }else{
               
        String SQLVerificar = "SELECT COUNT(*) AS cantidad FROM  proveedores p WHERE nombre=? AND activo = 'Si'";
  ...
  int filaSeleccionada=tblUsuarios.rowAtPoint(evt.getPoint());       // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formProveedores1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formProveedores1().setVisible(true);
            }
        });
    }
