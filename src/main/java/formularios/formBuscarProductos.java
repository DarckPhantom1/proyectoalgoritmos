...
public class formBuscarProductos extends javax.swing.JFrame {
  ...
  formfactura.txtId.setText(tblUsuarios.getValueAt(filaSeleccionada, 0).toString());
  formfactura.txtproducto.setText(tblUsuarios.getValueAt(filaSeleccionada, 1).toString());
   formfactura.txtMarca.setText(tblUsuarios.getValueAt(filaSeleccionada, 3).toString());
  formfactura.txtunidad.setText(tblUsuarios.getValueAt(filaSeleccionada, 2).toString());
   formfactura.txtPrecio.setText(tblUsuarios.getValueAt(filaSeleccionada, 4).toString());
   formfactura.txtunidades.setText(tblUsuarios.getValueAt(filaSeleccionada, 5).toString());
