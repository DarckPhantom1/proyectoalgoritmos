...
public class Reporte_Existencia extends javax.swing.JFrame {
    conexionSQL cc = new conexionSQL();
    Connection con= cc.conexion();
    public Reporte_Existencia() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String rutaPDF = "C:\\proyecto\\proyectoalgoritmos\\src\\main\\java\\Reportes\\reporte_inventarios.pdf";
        String rutaCarpeta = "C:\\proyecto\\proyectoalgoritmos\\src\\main\\java\\Reportes";
        String opc = jComboBox1.getSelectedItem().toString();
        String consultaSQL = null;

        switch (opc) {
            case "Si" -> // Consulta SQL
            consultaSQL = "SELECT nombre,unidadmedida,precioventa,marca,unidades,activo from producto where activo='Si'";
            case "No" -> // Consulta SQL
            consultaSQL = "SELECT nombre,unidadmedida,precioventa,marca,unidades,activo from producto where activo='No'";
            case "Todos" -> // Consulta SQL
            consultaSQL = "SELECT nombre,unidadmedida,precioventa,marca,unidades,activo from producto";
        }
        ...
        try {
            ...
            while (archivoPDF.exists()) {
                rutaPDF = rutaCarpeta + "\\reporte__reporte_inventarios" + contador + ".pdf";
            ...
            // Título del reporte
            documento.add(new Paragraph("Reporte de Inventarios", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 20, Font.BOLD)));
            ...
            tabla.addCell(new Paragraph("Medida", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD)));
            tabla.addCell(new Paragraph("Precio", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte_Existencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reporte_Existencia().setVisible(true);
            }
        });
    }
