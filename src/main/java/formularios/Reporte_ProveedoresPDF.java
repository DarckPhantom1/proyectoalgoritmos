...
public class Reporte_ProveedoresPDF extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String rutaPDF = "C:\\proyecto\\proyectoalgoritmos\\src\\main\\java\\Reportes\\reporte_proveedores.pdf";      
        ...
        switch (opc) {
            case "Si" -> // Consulta SQL
                consultaSQL = "SELECT idProveedor, nombre, telefono, direccion, activo FROM proveedores where activo='si'";
            case "No" -> // Consulta SQL
                consultaSQL = "SELECT idProveedor, nombre, telefono, direccion, activo FROM proveedores where activo='no'";
            case "Todos" -> // Consulta SQL
                consultaSQL = "SELECT idProveedor, nombre, telefono, direccion, activo FROM proveedores";
        }
